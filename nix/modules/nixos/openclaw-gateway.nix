  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.${cfg.unitName} = {
      ...
      environment = {
        ...
        # Openclaw reads $SHELL to determine which shell to spawn for
        # tool execution.  System users default to nologin, which causes
        # "This account is currently not available" errors.
